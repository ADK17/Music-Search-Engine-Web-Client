...
.factory('RzSlider', ['$timeout', '$document', '$window', 'throttle', function($timeout, $document, $window, throttle)
{
  ...
  var Slider = function(scope, sliderElem, attributes)
  {
    ...
    // Initialize slider
    var context = this;
    $timeout(function(){context.init()},20);
  };
  ...
  Slider.prototype = {
    ...
    init: function()
    {
      ...
      var thrLow, thrHigh, unRegFn,
        ...
        self = this;
        //console.log('befire initElemHandles');
      this.initElemHandles();
      //console.log('after initElemHandles, before calcViewDimensions');
      this.calcViewDimensions();
      //console.log('after calc dim');
      this.setMinAndMax();
    ...
    {
      //console.log('--SLIDER, initHandles--: models: ',this.valueToOffset(this.scope.rzSliderModel),this.scope.rzSliderHigh);
    ...
    {
      //console.log('initElemHandles');
      // Assign all slider elements to object properties for easy access
      angular.forEach(this.sliderElem.children(), function(elem, index)
      {
        var jElem = angular.element(elem);
        //console.log('initElemHandles',index);
        switch(index)
        {
          case 0: this.fullBar = jElem; break;
          case 1: this.selBar = jElem; break;
          case 2: this.minH = jElem;jw=jElem; break;
      ...
      //console.log('done initElemHandles');
    },
    ...
    {
      var handleWidth = this.getWidth(this.minH,'556');
      //console.log('calcViewDimensions: minH, fullBar -- ',this.minH,this.fullBar);
      this.handleHalfWidth = handleWidth / 2;
      this.barWidth = this.getWidth(this.fullBar,'559');

      this.maxLeft = this.barWidth - handleWidth;

      this.getWidth(this.sliderElem,'563');
    ...
    updateCeilLab: function()
    {
      ...
      this.getWidth(this.ceilLab,'582');
    },
    ...
    {
      //console.log("--SLIDER, updateLowHandle()--");
    ...
    {
      //console.log("UPDATE HIGH HANDLE(), offset: ",newOffset);
     ...
     * @returns {number}
     */
    getWidth: function(elem,line)
    {
      var val = elem[0].getBoundingClientRect();
      //console.log('getWidth',val.right,val.left);
      //if(line) console.log('called from ++ '+line)
    ...
    {
      //console.log(val,this.minValue,this.maxLeft,this.valueRange);
